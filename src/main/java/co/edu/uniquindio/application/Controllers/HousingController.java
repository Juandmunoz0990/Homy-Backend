...
public class HousingController {
    ...
    // @PostMapping("/create")
     // public ResponseEntity<EntityCreatedResponse> createHousing (@AuthenticationPrincipal Jwt jwt, @RequestBody CreateOrEditHousingRequest request){
        // Long hostId = jwt.getClaims("userId");
    ...
    // public ResponseEntity<EntityChangedResponse> deleteHousing (@PathVariable Long housingId, @AuthenticationPrincipal Jwt jwt){
        // Long hostId = jwt.getClaims("userId");
    ...
    // public ResponseEntity<EntityChangedResponse> editHousing (@PathVariable Long housingId, @AuthenticationPrincipal Jwt jwt, @RequestBody CreateOrEditHousingRequest request){
       // Long hostId = jwt.getClaims("userId");
